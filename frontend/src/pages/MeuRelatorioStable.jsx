    ...
    <div className="min-h-screen bg-[#050505] text-white">
      <div className="w-full mx-auto px-4 sm:px-5 lg:px-6 py-3" style={{ maxWidth: 1540 }}>
        ...
        <section className="grid grid-cols-1 xl:grid-cols-[1.35fr_0.8fr_0.9fr] gap-3" style={{ marginTop: 10 }}>
          ...
          <div className="rounded-xl border border-white/[0.08] bg-[#0b0d0f]" style={{ padding: 15 }}><SectionTitle>Distribuição do Período</SectionTitle><div className="space-y-3"><div><p className="text-sm font-black text-emerald-300">{report.distribution.stable}% Estável</p><p className="text-[11px] text-slate-400">Maior parte do período</p><div className="mt-2 h-2.5 rounded-full bg-white/10"></div><div><p className="text-sm font-black text-amber-300">{report.distribution.attention}% Atenção</p><p className="text-[11px] text-slate-400">Sinais de sobrecarga</p><div className="mt-2 h-2.5 rounded-full bg-white/10"></div><div><p className="text-sm font-black text-rose-300">{report.distribution.critical}% Crítico</p><p className="text-[11px] text-slate-400">Risco elevado presente</p><div className="mt-2 h-2.5 rounded-full bg-white/10"></div></div></div>
